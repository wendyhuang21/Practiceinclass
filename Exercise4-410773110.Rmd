...
params:
  ...
  repoURL: "你的作業github repo網址，為https://github.com/wendyhuang21a/Practiceinclass"
...
```{r ans13}
library(stringr)
colMeans(gsHW2ws[,c("ans1", "ans21", "ans22", "ans23", "ans24")], na.rm = TRUE)
```
...
```{r ans14}
library(stringr)
gsHW2ws$答對率 <- rowSums(gsHW2ws[,c("ans1","ans21","ans22","ans23","ans24")], na.rm = TRUE)/5
```
